"""Text API provider (optional).

Uses OpenAI-compatible API for text-only model calls.
Does not support image input, but supports tool calling.
"""
...
class TextAPIProvider(ModelProvider):
    """OpenAI-compatible text-only API provider (e.g., GPT-4o-mini)."""
    ...
    def _build_messages(self, messages: list[Message]) -> list[dict]:
        ...
        for msg in messages:
            ...
            # Text provider only accepts string content
